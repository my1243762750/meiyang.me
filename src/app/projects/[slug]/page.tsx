  ...
  return (
    <article className="flex flex-col gap-8">
      ...
      <header className="flex flex-col gap-3">
        <h1 className="text-3xl font-bold text-[var(--color-text-primary)]">{project.meta.title}</h1>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="text-sm text-[var(--color-text-tertiary)]">{project.meta.date}</span>
        </div>
      </header>
